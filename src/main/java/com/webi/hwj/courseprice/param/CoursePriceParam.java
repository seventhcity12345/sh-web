package com.webi.hwj.courseprice.param;
...
public class CoursePriceParam implements Serializable {
  /** 
  * 
  */
  private static final long serialVersionUID = 7429634299410226799L;
  // 主键id
  ...
  // 单位(前端显示中文)
  private String coursePriceUnitTypeName;
  // 创建日期
  ...
  public String getCoursePriceUnitTypeName() {
    return coursePriceUnitTypeName;
  }

  public void setCoursePriceUnitTypeName(String coursePriceUnitTypeName) {
    this.coursePriceUnitTypeName = coursePriceUnitTypeName;
  }
