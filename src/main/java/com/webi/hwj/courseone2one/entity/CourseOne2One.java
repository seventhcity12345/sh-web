package com.webi.hwj.courseone2one.entity;
...
/**
 * @category courseOne2one Entity
 * @author mingyisoft代码生成工具
 */
@TableName("t_course_one2one")
public class CourseOne2One implements Serializable {
  private static final long serialVersionUID = -8038303015830881209L;
  // 主键id
