/** 
 * File: WebiHwjOrderCourse.java<br> 
 * Project: hwj-svn<br> 
...
/**
 * Title: 需要提交给快钱的参数bean Description: WebiHwjOrderCourse<br>
 * 需要提交给快钱的参数bean Company: 韦博英语在线教育部<br>
 * CreateDate:2015年8月14日 下午6:47:17
 * 
 * @author athrun.cw
 */
public class WebiHwjOrderCourse implements Serializable {

  private static final long serialVersionUID = 1L;

  /**
   * 标识使用快钱支付的领域：用于购买speakhi合同订单签约，，，...等等
   */
  // 该字段,是工资自定义的
  ...
  public String toString() {
    return "WebiHwjOrderCourse [payFrom=" + payFrom + ", merchantAcctId="
        + merchantAcctId + ", inputCharset=" + inputCharset
        + ", pageUrl=" + pageUrl + ", bgUrl=" + bgUrl + ", version="
        + version + ", language=" + language + ", signType=" + signType
        + ", payerName=" + payerName + ", payerContactType="
        + payerContactType + ", payerContact=" + payerContact
        + ", orderId=" + orderId + ", orderAmount=" + orderAmount
        + ", orderTime=" + orderTime + ", productName=" + productName
        + ", productNum=" + productNum + ", productId=" + productId
        + ", productDesc=" + productDesc + ", ext1=" + ext1 + ", ext2="
        + ext2 + ", payType=" + payType + ", bankId=" + bankId
        + ", redoFlag=" + redoFlag + ", pid=" + pid + ", signMsgVal="
        + signMsgVal + "]";
  }
