...
public class UserLoginValidationForm {

  @ApiModelProperty(value = "手机号", required = true, example = "18600609747")
  ...
  @ApiModelProperty(value = "一个月免登录", example = "true")
