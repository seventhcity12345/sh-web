...
public class CourseCommentParam implements Serializable {
  ...
  // 是否是demo课（demo需要老师选择学生是否出席）
  private Boolean isDemo;
  // 学生是否出席（demo才需要）
  private Integer studentIsShow;
  ...
  public Integer getStudentIsShow() {
    return studentIsShow;
  }

  public void setStudentIsShow(Integer studentIsShow) {
    this.studentIsShow = studentIsShow;
  }
