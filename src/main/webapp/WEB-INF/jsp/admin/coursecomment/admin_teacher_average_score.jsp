...
<script type="text/javascript">
	...
	function reloadDataGrid(){
		...
		$('#dataGrid1').datagrid({
		    url:basePath + '/admin/courseComment/findTeacherAverageScrorePage?startTime='+startTime
		    		+'&endTime='+endTime});
	}
	...
	<table id="dataGrid1" name="dataGrid1" class="easyui-datagrid"
		...
		<thead>
			<tr>
				...
				<th data-options="field:'preparationScore',width:'100',sortable:true,formatter:formatNum">准备度平均</th>
				<th data-options="field:'deliveryScore',width:'50',sortable:true,formatter:formatNum">专业度平均</th>
				<th data-options="field:'interactionScore',width:'50',sortable:true,formatter:formatNum">互动性平均</th>
				<th data-options="field:'showScore',width:'100',sortable:true,sortable:true,formatter:formatNum">综合平均</th>
				<th data-options="field:'commentCount',width:'100',sortable:true">评价人数</th>
			</tr>
		</thead>
	</table>
