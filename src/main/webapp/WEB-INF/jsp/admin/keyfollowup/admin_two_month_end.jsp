...
<script type="text/javascript">
	...
	function findAllStudent() {
		$('#dataGrid1').datagrid('options').url = basePath
				+ '/admin/keyFollowup/findKeyFollowupStudentPage?findAllFlag=true&findType=twoMonthEnd';
		var queryParams = {};
...
<body>
	<table id="dataGrid1" name="dataGrid1" class="easyui-datagrid"
		...
		data-options="pageList:[100,200],pagination:true,pageSize:100,fit:true,singleSelect:true,
				rownumbers:true,url:'${ctx}/admin/keyFollowup/findKeyFollowupStudentPage?findAllFlag=false&findType=twoMonthEnd',
		...
		<thead>
			<tr>
				...
				<th data-options="field:'adminUserName',width:'50',sortable:true,ambiguous:'tbu'">LC名字</th>
				<th data-options="field:'ccName',width:'50',sortable:true,dbColumnName:'tbucc.admin_user_name',ambiguous:'tbucc'">CC名字</th>
				<th
					data-options="field:'phone',width:'100',sortable:true,sortable:true">手机号</th>
				<th
					data-options="field:'endOrderTime',width:'100',sortable:true,formatter:formatDate">合同结束时间</th>
				<th data-options="field:'followupCount',width:'100',sortable:true">合计Follow次数</th>
				<th
