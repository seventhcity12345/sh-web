...
<script type="text/javascript">
	...
	function findAllStudent() {
		$('#dataGrid1').datagrid('options').url = basePath
				+ '/admin/keyFollowup/findKeyFollowupStudentPage?findAllFlag=true&findType=oneMonthNotDoRsa';
		var queryParams = {};
...
<body>
	<table id="dataGrid1" name="dataGrid1" class="easyui-datagrid"
		...
		data-options="pageList:[100,200],pagination:true,pageSize:100,fit:true,singleSelect:true,
				rownumbers:true,url:'${ctx}/admin/keyFollowup/findKeyFollowupStudentPage?findAllFlag=false&findType=oneMonthNotDoRsa',
		...
		<thead>
			<tr>
				...
				<th
					...
					<th
					data-options="field:'lastCoursewareDate',width:'100',formatter:formatDate,unableGroupSearch:true">最后做课件时间</th>
					<th
					data-options="field:'lastClassDate',width:'100',formatter:formatDate,unableGroupSearch:true">最后一次上课时间(1v1)</th>
				<th data-options="field:'followupCount',width:'100',unableGroupSearch:true">后继Follow次数</th>
				<th
