...
<script type="text/javascript">
	...
	function findAllStudent() {
		$('#dataGrid1').datagrid('options').url = basePath
				+ '/admin/keyFollowup/findKeyFollowupStudentPage?findAllFlag=true&findType=newStudent';
		var queryParams = {};
...
<body>
	<table id="dataGrid1" name="dataGrid1" class="easyui-datagrid"
		...
		data-options="pageList:[100,200],pagination:true,pageSize:100,fit:true,singleSelect:true,
				rownumbers:true,url:'${ctx}/admin/keyFollowup/findKeyFollowupStudentPage?findAllFlag=false&findType=newStudent',
