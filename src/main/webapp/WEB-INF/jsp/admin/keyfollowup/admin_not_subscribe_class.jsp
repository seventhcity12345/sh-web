...
<script type="text/javascript">
	...
	function findAllStudent() {
		$('#dataGrid1').datagrid('options').url = basePath
				+ '/admin/keyFollowup/findKeyFollowupStudentPage?findAllFlag=true&findType=notSubscribeClass';
		var queryParams = {};
...
<body>
	<table id="dataGrid1" name="dataGrid1" class="easyui-datagrid"
		...
		data-options="pageList:[100,200],pagination:true,pageSize:100,fit:true,singleSelect:true,
				rownumbers:true,url:'${ctx}/admin/keyFollowup/findKeyFollowupStudentPage?findAllFlag=false&findType=notSubscribeClass',
		...
		<thead>
			<tr>
				...
				<th
					data-options="field:'courseTitle',width:'100',sortable:true">课件名称</th>
				<th
					data-options="field:'firstCompleteTime',width:'100',sortable:true,formatter:formatDate">课件达标时间</th>
				<th data-options="field:'tmmPercent',width:'100',sortable:true">课件完成率</th>
				<th
