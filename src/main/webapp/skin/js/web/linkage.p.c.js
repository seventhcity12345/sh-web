...
function init(obj_1,obj_2,obj_3){
	...
	var ar = ["省份","城市","县区"];
		...
		//初始化
		$("<option class='o-first' value=''>"+ar[0]+"</option>").appendTo($("#"+obj_1));
		$("<option class='o-first' value=''>"+ar[1]+"</option>").appendTo($("#"+obj_2));
		$("<option class='o-first' value=''>"+ar[2]+"</option>").appendTo($("#"+obj_3));
...
function initBirth(obj_1,obj_2,obj_3) {
	var initItem = ["请选择","请选择","请选择"];

	//初始化
	$("<option>"+initItem[0]+"</option>").appendTo($("#"+obj_1));
	$("<option>"+initItem[1]+"</option>").appendTo($("#"+obj_2));
	$("<option>"+initItem[2]+"</option>").appendTo($("#"+obj_3));

	var curYear = (new Date()).getFullYear();

	//初始化p-year
	for (i=curYear-70;i<=curYear;i++){
		$("<option>"+i+"</option>").appendTo($("#"+obj_1));
	}
	...
	$("#"+obj_1).change(function(){
		//获取索引
		yindex = $("#"+obj_1).get(0).selectedIndex;
		//清空c和h
		$("#"+obj_2).empty();
		$("#"+obj_3).empty();
		//重新给c填充内容
		...
		if (yindex != 0) {
			for (i=1;i<=12;i++){
				$("<option>"+i+"</option>").appendTo($("#"+obj_2));
			}
		};
	});
	...
	$("#"+obj_2).change(function(){
		//获取索引
		mindex = $("#"+obj_2).get(0).selectedIndex;
		//清空c和h
		$("#"+obj_3).empty();
		//重新给c填充内容
		$("<option>"+initItem[2]+"</option>").appendTo($("#"+obj_3));
		switch (mindex) {
			case 0:
				...
				break;
			case 2:
				if (isLeapYear(Number($("#"+obj_1).find("option:selected").text()))) {
					for (i=1;i<=29;i++){
						$("<option>"+i+"</option>").appendTo($("#"+obj_3));
					}
				} else {
					for (i=1;i<=28;i++){
						$("<option>"+i+"</option>").appendTo($("#"+obj_3));
